...
import co.chiraggada.furn360.networksync.LoginRequest;
...
//                                    countFirebaseValues();
                                    ...
                                    if(jsonObject.getString("status").equals("INVALID")) {
                                        String sessionname = "chirag";
                                        sessionmobile = "9920817447";
                                        String sessionemail = "chiraggada67@gmail.com";
                                        String sessionphoto = jsonObject.getString("url");
                                        session.createLoginSession(sessionname, sessionemail, sessionmobile, sessionphoto);
